...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<tilt>.freeze, ["< 2.0", "~> 1.4.1"])
      ...
      s.add_runtime_dependency(%q<listen>.freeze, ["< 3.0", ">= 2.7.9"])
      ...
      s.add_dependency(%q<tilt>.freeze, ["< 2.0", "~> 1.4.1"])
      ...
      s.add_dependency(%q<listen>.freeze, ["< 3.0", ">= 2.7.9"])
